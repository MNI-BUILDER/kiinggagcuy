...
-- The "Time Until Restock: 02:14:14" label sits NEXT TO FruitFrame, not inside it.
...
local function buildPayload()
    ...
    for key, f in pairs(Cache.goodFruits) do
    ...
    if ok then
        ...
        if data then
            print((data.live and "🟢 LIVE  " or "🟡 CACHED(" .. data.scrapeAge .. "s) ")
                .. data.stockCount .. "/" .. data.totalFruits .. " in stock ["
